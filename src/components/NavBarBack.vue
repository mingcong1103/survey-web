      ...
      <div class="container">
        ...
        <div id="navbarBasicExample" class="navbar-menu">
          <div class="navbar-start">
            ...
            <a class="navbar-item">Investigation activities</a>
            <a class="navbar-item">Participate in the survey</a>
            <a class="navbar-item">Promotion Commission</a>
            <a class="navbar-item">Service Ticket</a>
          </div>
            ...
            <div class="navbar-item">
              <div class="buttons">
                <a class="button is-primary">
                  <router-link to="/register" class="has-text-white">Sign up</router-link>
                </a>
                <a class="button is-light">
                  <router-link to="/login" class="has-text-black">Log in</router-link>
                </a>
              </div>
            </div>
          </div>
          <div v-else class="navbar-end">
            <div class="navbar-item has-dropdown is-hoverable">
              <a class="navbar-link">Hello, Cong!</a>
              <div class="navbar-dropdown">
                <router-link to="/userCenter" class="navbar-item">My Wallet</router-link>
                <router-link to="/userCenter" class="navbar-item">User Management</router-link>
                <router-link to="/userCenter" class="navbar-item">Questionnaire History</router-link>
                <router-link to="/userCenter" class="navbar-item">Notification Information</router-link>
                <router-link to="/userCenter" class="navbar-item">Change Password</router-link>
                <router-link to="/userCenter/profile" class="navbar-item">You Profile</router-link>
            ...
            <div class="navbar-item">
              <div class="buttons">
                <a class="button is-primary">
                  <router-link to="/userCenter" class="has-text-white">ClientArea</router-link>
                </a>
              </div>
            </div>
          </div>
